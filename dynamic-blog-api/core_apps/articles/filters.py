...
# for getting custom filtered queryset django_filters is used.
# refer docs https://django-filter.readthedocs.io/en/stable/ref/filterset.html
# refer docs https://django-filter.readthedocs.io/en/stable/ref/filters.html
class ArticleFilter(filters.FilterSet):
    # making a custom filter 
    # all the custome filters below are expected to be used for Article model alone
