...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, username, first_name, last_name, email, password=None,
        ...
        if not last_name:
            raise ValueError(
                _("If you can have a firstname, I bet you can also have lastname"
                  ))
        ...
        if email:
            ...
            raise ValueError(
                _("Sorry, but this app will not work without providing a valid email address"
                  ))
    ...
    def create_superuser(self, username, first_name, last_name, email,
        ...
        if email:
            ...
            raise ValueError(
                _("An admin account must have a valid email address"))
